              ...
              <div class="col-md-8 text-center">
                ...
                <?php
                    ...
                    $pincode = $_POST['pincode'];
                      $sql = mysqli_query($conn,"update customer set firstname='$firstname', lastname='$lastname',email='$email',mobile='$mobile',country='$country',state='$state',city='$city',area='$area',pincode='$pincode' where id='$id'"); 
                ...
                <?php
                    ...
                    $area = $_POST['area'];
                    $pincode = $_POST['pincode'];
                      $sql = mysqli_query($conn,"update business_owner set firstname='$firstname', lastname='$lastname',email='$email',mobile='$mobile',category='$category',sub_cat='$sub_cat',country='$country',state='$state',city='$city',area='$area',pincode='$pincode' where id='$id'");  
          ...
          <div class="col-md-12 mb-5">
            ...
            <form action="" method="post" class="p-5 bg-white" style="margin-top: -150px;">
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  <label class="text-black" for="country">State</label> 
                  <input type="text" id="state" class="form-control" value="'.$row['state'].'" name="state" required>
                </div>
              </div>
              ...
              <div class="row form-group">
                ...
                <div class="col-md-12">
                  <label class="text-black" for="area">Pincode</label> 
                  <input type="text" id="pincode" class="form-control" value="'.$row['pincode'].'" name="pincode" required>
                </div>
              </div>
              <div class="row form-group">
                <div class="col-md-12">
