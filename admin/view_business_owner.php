  ...
  <div class="site-wrap">
    ...
    <div class="site-section bg-light table-outer">
                ...
                <table class="table table-responsive-md">
                  ...
                  <tbody>
                <?php
                $sql = mysqli_query($conn,"select * from business_owner");
                ...
                ?>  
                    ...
                    <tr>
                      ...
                      <td><a href="edit.php?id=<?php echo $row['id']; ?>&type=<?php echo 'owner'; ?>" class="btn btn-primary" style='color:white;'>Edit</a></td>
                      <td><a href="delete.php?id=<?php echo $row['id']; ?>&type=<?php echo 'owner'; ?>" class="btn btn-danger" style='color:white;'>Delete</a></td>
                    </tr>
