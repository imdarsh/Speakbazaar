...
if(isset($_POST['search'])){
  ...
  if(isset($_SESSION["id"])){
    header('location: filter.php?place='.$place.'&location='.$location.'&category='.$category);
  }
  else {
  ...
  <div class="site-wrap">
          ...
          <div class="col-md-10">
            ...
            <div class="row justify-content-center mb-4">
              <div class="col-md-10 text-center">
                ...
                <p data-aos="fade-up" data-aos-delay="100">Find B2B & B2C businesses contact addrsses, phone numbers, user ratings and reviews</p>
              </div>
            </div>
              ...
              <form method="post" action="">
                <div class="row align-items-center">
                  <div class="col-lg-12 col-xl-4 no-sm-border border-right">
                    <input type="text" class="form-control" name="place" placeholder="What are you looking for?" required>
                  </div>
                  ...
                  <?php
                    $query2 = mysqli_query($conn,"select distinct city from business_owner");
                  ...
                  <?php
                    $query = mysqli_query($conn, "select category from data_item");
                  ...
                  <div class="col-lg-12 col-xl-2 ml-auto text-right">
                    <input type="submit" class="btn text-white btn-info" name="search" value="Search">
                  </div>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-info">
        ...
        <div class="row mt-5 justify-content-center tex-center">
          <div class="col-md-4"><a href="#" class="btn btn-block btn-outline-info btn-md px-5">View All Categories</a></div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-5 ml-auto">
            <h2 class="text-info mb-3">Why Us</h2>
            <div class="row mt-4">
              <div class="col-12">
    ...
    <div class="site-section bg-light">
      <div class="container">
        ...
        <div class="row justify-content-center mb-5">
          <div class="col-md-7 text-center border-info">
            <h2 class="font-weight-light text-info">Satisfied Customers</h2>
          </div>
        </div>
